...
# Custom version of istn-reg.py which can print out all the affine matrices
...
from pymira_custom.nets.itn import ITN2D, ITN3D
...
# Save Normally Warped Image as png
...
# Save Refined Warped image as png
...
if __name__ == '__main__':
    ...
    if args.test is not None:
        ...
        # initialize warped and refined warped images
        ...
        # check to make sure I got all the affine matrices for all the testset images

        print("Number of Affine Matrices for Warping: ", len(affineMatricesWarped))
        print("Number of Affine Matrices for Refined Warping: ", len(affineMatricesWarped))
        
        # save the affine matrices in .dat files
