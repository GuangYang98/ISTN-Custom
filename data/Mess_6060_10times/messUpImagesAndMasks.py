...
for i in range(0, 1100):
    ...
    inputImgName = "mask" + zeroPadName(index) + ".png"
    readReshapeOutputImage(inputFolder, normalOutputFolder,  rotatedOutputFolder, inputImgName, angle, i, False) #知道顺序然后顺着读

    inputFolder = INPUT_MASKS_FOLDER
    normalOutputFolder = "Train_Masks"
    rotatedOutputFolder = "Train_Masks_Unaligned"
    inputImgName = str(index) + ".png"
    readReshapeOutputImage(inputFolder, normalOutputFolder, rotatedOutputFolder, inputImgName, angle, i, True)
